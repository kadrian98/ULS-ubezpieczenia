<?php get_header(); ?>
		...
		<section class="slider">			
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('<?php echo get_theme_file_uri('/img/insurance-bg.jpg') ?>');background-position: center;
							...
							<div class="single-schedule first">
								<div class="inner">
									...
									<div class="single-content">
										<span>ULS</span>
										<h4>Ubezpieczenia</h4>
										<p>"Dołącz do zadowolonych klientów - wybierz nasze kompleksowe usługi ubezpieczeniowe już teraz!"</p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-12">
							...
							<div class="single-schedule middle">
								<div class="inner">
									...
									<div class="single-content">
										<span>Kalkulacja OC</span>
										<h4>Wypełnij formularz</h4>
										<p>Wypełnij prosty formularz online i znajdź ubezpieczenie idealne dla siebie - szybko, łatwo, wygodnie.</p>
									</div>
								</div>
							</div>
						</div>
