...
function uls_style() {
  wp_enqueue_style( 'poppins-font', 'https://fonts.googleapis.com/css?family=Poppins:200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap', array(), null );
  ...
  wp_enqueue_script( 'popper', get_stylesheet_directory_uri() . '/js/popper.min.js', array(), false, true );
  wp_enqueue_script( 'bootstrap-script', get_stylesheet_directory_uri() . '/js/bootstrap-datepicker.js', array(), false, true );
  wp_enqueue_script( 'jquerynav', get_stylesheet_directory_uri() . '/js/jquery.nav.js', array(), false, true );
  wp_enqueue_script( 'slick-nav', get_stylesheet_directory_uri() . '/js/slicknav.min.js', array(), false, true );
  wp_enqueue_script( 'jqscroll', get_stylesheet_directory_uri() . '/js/jquery.scrollUp.min.js', array(), false, true );
  wp_enqueue_script( 'niceselect', get_stylesheet_directory_uri() . '/js/niceselect.js', array(), false, true );
  ...
  wp_enqueue_script( 'jqcounter', get_stylesheet_directory_uri() . '/js/jquery.counterup.min.js', array(), false, true );
  ...
  wp_enqueue_script( 'magnific-js', get_stylesheet_directory_uri() . '/js/jquery.magnific-popup.min.js', array(), false, true );
